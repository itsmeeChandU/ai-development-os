    ...
    artifacts = {
        ...
        "public_trade_readiness_manifest.json": {
            ...
            "modes": {
                ...
                "market_readiness_evidence_room": "Maps real go-live input requests into operator work orders, captures returned inputs locally, and shows a returned-input ledger while keeping market-ready claims closed.",
            },
