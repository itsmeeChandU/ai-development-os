...
```json
{
  ...
  "generated_at": "2026-06-26T01:24:57+00:00",
  ...
  "routines": [
    ...
    },
    {
      ...
      "commands": [
        "python3 scripts/agentic_workflow_orchestrator.py harness-intake --harness ecc --install-mode observe --target-repo ai-development-os --out-dir system_review_graph",
