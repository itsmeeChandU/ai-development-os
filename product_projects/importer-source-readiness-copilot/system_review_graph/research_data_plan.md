...
```json
{
  ...
  "data_need": "supplier/importer source data, official country import export rules, tariffs, certifications, contracts, buyer validation, current web and official source evidence",
  "data_routes": [
    {
      "allowed_sources": [
        "local fixtures",
  ...
  "problem": "Build a blocked-safe importer/exporter source readiness copilot for product operators using source cards, official-source placeholders, country requirement gaps, contracts, buyer validation, and expert review gates.",
  "research_depths": [
    {
      "id": "R0_MODEL_PRIOR",
