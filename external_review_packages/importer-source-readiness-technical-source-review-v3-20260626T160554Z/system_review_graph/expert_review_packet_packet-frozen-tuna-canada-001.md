...
- evidence-frozen-tuna-cid-reference: official_reference | blocked_stale_source | Reference-only source. It does not prove supplier suitability, tariff classification, CFIA clearance, buyer demand, or import approval.
- evidence-frozen-tuna-cbsa-import-workflow: official_reference | blocked_stale_source | Reference-only source. It does not create customs, tariff, release, accounting, or compliance advice.
- evidence-frozen-tuna-cfia-airs-reference: official_reference | blocked_stale_source | Reference-only source. It does not prove CFIA clearance or legal compliance.

## Grouped Blockers

- Source Freshness: Refresh official sources and keep claims reference-only until qualified review.
