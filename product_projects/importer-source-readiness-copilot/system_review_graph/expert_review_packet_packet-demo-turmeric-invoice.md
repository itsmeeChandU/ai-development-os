...
Packet: Demo turmeric invoice readiness quick check
Product: Demo turmeric invoice
...
- evidence-packet-demo-turmeric-invoice-public-upload-1: customer_uploaded_document | blocked_reference_only | Uploaded document metadata supports only draft review until qualified review and source freshness exist.
...
- Canada Import Responsibility: Confirm who is importer of record, whether terms are buyer-import or delivered/DDP, and route to broker review.
- Canada Import Controls: Check official Canadian references and generate a broker review packet before any shipment decision.
- Document Readiness: Attach proof of origin and keep preference or MoU claims blocked until official evidence and qualified review exist.
- Exporter-Side Readiness: Collect origin-country export readiness evidence or assign an expert lane for country-specific review.
