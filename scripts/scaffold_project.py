...
- For board/go-live readiness, generate `system_review_graph/board_go_live_readiness_report.json` plus `board/*.md` with jurisdiction tools, simulated expert lanes, launch controls, human approval gates, and closed public-launch/legal/financial/compliance claims.
