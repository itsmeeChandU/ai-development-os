    ...
    return [
        {
            ...
            "proof": "entity schema contract plus migration map is present in production_redevelopment_plan.json",
        },
        {
            "id": "packet_engine",
            "phase": 2,
            ...
            "proof": "packet state machine and packet view requirements are machine-readable",
        },
        {
            ...
            "proof": "country/source phases are linked to CBSA, CFIA, ISED, and ITC research anchors",
        },
        {
