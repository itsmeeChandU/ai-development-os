...
```json
{
  "execution_plan": {
    ...
    "goal": "Build the first verified product loop from a startup idea using AI Development OS, SRG, code-review graph, worktrees, GitHub, Ruflo coordination, proof gates, and handoffs.",
    "lane_packets": [
      {
        "allowed_files": [
          "AGENTS.md",
        ...
        "branch": "codex/workflow-coordinator-20260625-prompt-to-product-runtime",
        "forbidden_files": [
          "LICENSE",
          "NOTICE.md",
        ...
        "worktree_commands": [
          "git fetch origin",
          "git worktree add /Users/chandu/.codex/worktrees/ai-dev-os-workflow/ai-development-os-workflow-coordinator -b codex/workflow-coordinator-20260625-prompt-to-product-runtime origin/main"
        ]
      },
      {
        "allowed_files": [
        ...
        "branch": "codex/srg-context-bundle-20260625-prompt-to-product-runtime",
        "forbidden_files": [
        ...
        "worktree_commands": [
          "git fetch origin",
          "git worktree add /Users/chandu/.codex/worktrees/ai-dev-os-workflow/system-review-graph-srg-context-bundle -b codex/srg-context-bundle-20260625-prompt-to-product-runtime origin/main"
        ]
      },
      {
        "allowed_files": [
        ...
        "branch": "codex/code-review-contract-20260625-prompt-to-product-runtime",
        "forbidden_files": [
        ...
        "worktree_commands": [
          "git fetch origin",
          "git worktree add /Users/chandu/.codex/worktrees/ai-dev-os-workflow/code-review-graph-code-review-contract -b codex/code-review-contract-20260625-prompt-to-product-runtime origin/main"
        ]
      },
      {
        "allowed_files": [
        ...
        "branch": "codex/ih-contract-export-20260625-prompt-to-product-runtime",
        "forbidden_files": [
          "app/**",
          "graph/**",
          "market_system/**",
        ...
        "worktree_commands": [
          "git fetch origin",
          "git worktree add /Users/chandu/.codex/worktrees/ai-dev-os-workflow/intelligence-hub-ih-contract-export -b codex/ih-contract-export-20260625-prompt-to-product-runtime origin/main"
        ]
      },
      {
        "allowed_files": [
        ...
        "branch": "codex/integration-reviewer-20260625-prompt-to-product-runtime",
        "forbidden_files": [
          "all writes"
        ],
    ...
    "run_id": "20260625-prompt-to-product-runtime",
    "slash_commands": [
      {
  ...
  "product": {
    "complexity": {
      "level": "S4",
      "reason": "physical, OS, firmware, or hardware terms present"
    },
    "idea": "Build the first verified product loop from a startup idea using AI Development OS, SRG, code-review graph, worktrees, GitHub, Ruflo coordination, proof gates, and handoffs.",
    "name": "prompt-to-product-runtime"
  },
  "slash_commands": [
    "/ados:normalize",
    "/ados:context-bundle",
