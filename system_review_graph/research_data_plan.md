...
```json
{
  ...
  "data_need": "official country rules, import/export requirements, source rights, buyer validation, contract terms, qualified compliance review, investor pitch evidence",
  "data_routes": [
    {
      "allowed_sources": [
        "local fixtures",
