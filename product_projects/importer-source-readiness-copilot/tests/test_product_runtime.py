...
class ProductRuntimeTests(unittest.TestCase):
    ...
    def test_runtime_state_has_auth_rbac_reviews_audit_and_deployment(self) -> None:
        ...
        self.assertIn("/api/trade-discovery", runtime["api_routes"])
        self.assertIn("/api/trade-data-catalog", runtime["api_routes"])
        ...
        self.assertIn("/api/launch-control-plane", runtime["api_routes"])
        ...
        self.assertIn("/api/packets/:id/scores", runtime["api_routes"])
        self.assertIn("/api/packets/:id/blocked-claims", runtime["api_routes"])
        self.assertIn("/api/documents/upload", runtime["api_routes"])
        self.assertIn("/api/sources/refresh", runtime["api_routes"])
        self.assertIn("/api/reviews", runtime["api_routes"])
        self.assertIn("/api/reports", runtime["api_routes"])
        self.assertIn("/api/ai/safe-summary", runtime["api_routes"])
        self.assertIn("/api/api-keys", runtime["api_routes"])
        self.assertIn("/api/webhooks", runtime["api_routes"])
        ...
        self.assertIn("/trade-discovery", runtime["ui_routes"]["customer"])
        self.assertIn("/trade-data-catalog", runtime["ui_routes"]["customer"])
        ...
        self.assertIn("/market-readiness", runtime["ui_routes"]["customer"])
